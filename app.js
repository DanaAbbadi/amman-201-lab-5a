...
function sumAndMultiply(a, b, c) { //eslint-disable-line
    ...
    var sumOf3= sum(c, sumfirst)[0];
    
    var mulfirst= multiply(a,b)[0];
    var mulOf3= multiply(c, mulfirst)[0];
    var msg1 = `4 and 7 and 5 sum to 16.`;
    var msg2 = 'The product of 4 and 7 and 5 is 140.';
    
    return [sumOf3,mulOf3,msg1, msg2];
...
function multiplyArray(multArr) { //eslint-disable-line
    var mul1 = multiply(multArr[0], multArr[1])[0];

    var mul2 = multiply(mul1, multArr[2])[0];
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    ...
    var msg='The numbers 1,2,3,4,5 have a product of 120.';
    return[mul, msg]
}
